...
BLOCK_TRANSLATIONS = {
    ...
    "Gothic": "哥特字母",
    "Old Permic": "古彼尔姆文字",
    "Latin Extended-C": "拉丁语扩展-C",
    "Latin Extended-D": "拉丁语扩展-D",
    "Latin Extended-E": "拉丁语扩展-E",
    "Latin Extended-F": "拉丁语扩展-F",
    "Latin Extended-G": "拉丁语扩展-G",
    ...
    "Arabic Extended-B": "阿拉伯语扩展-B",
    "Arabic Extended-C": "阿拉伯语扩展-C",
    "Thaana": "它拿字母",
    "NKo": "西非书面语言 (NKo)",
    "Samaritan": "撒马利亚语",
    "Mandaic": "曼底安语",
    ...
    "Ethiopic Extended-A": "埃塞俄比亚语扩展-A",
    "Ethiopic Extended-B": "埃塞俄比亚语扩展-B",
    "Tifinagh": "提非纳文字文字",
    "Vai": "瓦伊语",
    "Bamum": "巴姆穆语",
    "Bamum Supplement": "巴姆穆语补充",
    "Adlam": "阿德拉姆文字",
    "Osage": "欧塞奇字母",
    "Old South Arabian": "古南阿拉伯字母",
    "Old North Arabian": "古北阿拉伯字母",
    "Phoenician": "腓尼基字母",
    "Imperial Aramaic": "帝国亚拉姆语",
    "Manichaean": "摩尼教字母",
    "Psalter Pahlavi": "赞美诗帕拉维文",
    "Old Sogdian": "古粟特字母",
    "Sogdian": "粟特字母",
    "Old Uyghur": "古回鹘字母",
    "Chorasmian": "花剌子模字母",
    ...
    "Marchen": "玛琴文",
    "Masaram Gondi": "贡德文字",
    "Gunjala Gondi": "贡贾拉贡德文字",
    "Nandinagari": "楠迪纳加里文",
    "Dives Akuru": "迪维希语阿库鲁文",
    "Kaktovik Numerals": "卡克托维克数字",
    "Nag Mundari": "纳格蒙达里文",
    "Kawi": "卡维文",
    "Sunuwar": "苏努瓦尔文",
    "Tulu-Tigalari": "图卢-蒂加拉里文",
    ...
    "CJK Unified Ideographs Extension H": "中日韩统一表意文字扩展区-H",
    "CJK Unified Ideographs Extension I": "中日韩统一表意文字扩展区-I",
    "CJK Unified Ideographs Extension J": "中日韩统一表意文字扩展区-J",
    "Tangut": "西夏文",
    ...
    "Nushu": "女书",
    "Lisu": "栗僳语 (老栗僳文)",
    "Lisu Supplement": "栗僳语补充",
    "Miao": "苗语 (柏格理苗文)",
    "Small Kana Extension": "小假名扩展",
    ...
    "Supplemental Arrows-C": "补充箭头-C",
    "Chess Symbols": "国际象棋符号",
    "Symbols and Pictographs Extended-A": "符号及象形文字扩展-A",
    "Symbols for Legacy Computing": "传统计算符号",
    "Symbols for Legacy Computing Supplement": "传统计算符号补充",
    "Miscellaneous Symbols Supplement": "杂项符号补充",
    "Ancient Symbols": "古符号",
    "Phaistos Disc": "费斯托斯圆盘文字",
    "Domino Tiles": "多米诺骨牌",
    "Mahjong Tiles": "麻将牌",
    "Playing Cards": "扑克牌",
    "Musical Symbols": "音乐符号",
    "Byzantine Musical Symbols": "拜占庭音乐符号",
    "Ancient Greek Musical Notation": "古希腊音乐记谱法",
    "Znamenny Musical Notation": "兹纳梅尼音乐符号",
    "Mayan Numerals": "玛雅数字",
    ...
    "Ornamental Dingbats": "装饰性丁字符号",
    "Supplemental Symbols and Pictographs": "补充符号及象形文字",

    # Southeast Asian & Oceanic
    "Tagalog": "塔加路语",
    "Hanunoo": "哈努诺字母",
    "Buhid": "布希德文",
    "Tagbanwa": "塔格巴努亚文",
    "Tai Viet": "泰越文",
    "Hanifi Rohingya": "哈乃斐罗兴亚文字",
    "Makasar": "望加锡文",

    # Ancient & Historical
    "Linear B Syllabary": "线形文字B音节文字文字",
    ...
    "Old Turkic": "古突厥文 (鄂尔浑文)",
    "Cuneiform": "楔形文字",
    "Cuneiform Numbers and Punctuation": "楔形文字数字和标点",
    "Egyptian Hieroglyphs": "埃及圣书体 (象形文字)",
    "Egyptian Hieroglyph Format Controls": "埃及圣书体格式控制符",
    "Anatolian Hieroglyphs": "安纳托利亚象形文字",
    "Meroitic Hieroglyphs": "梅里埃象形文字",
    "Meroitic Cursive": "梅里埃草书",
    "Old South Arabian": "古南阿拉伯字母",
    "Old North Arabian": "古北阿拉伯字母",
    "Old Hungarian": "古匈牙利字母 (卢恩文字)",
    "Old Italic": "古意大利字母",
    "Lydian": "吕底亚语",
    "Lycian": "吕底亚字母",
    "Carian": "卡里亚字母",
    ...
    "Supplementary Private Use Area-A": "补充私用区-A",
    "Supplementary Private Use Area-B": "补充私用区-B",
    "Variation Selectors Supplement": "变体选择器补充",
}
